...
export function ServiceHero({ title, subtitle, description, iconElement }: ServiceHeroProps) {
    return (
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-24 pb-32 font-sans selection:bg-primary/20">
            {/* Background Effects */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <Link href="/services" className="group flex items-center gap-2 text-sm font-bold text-muted-foreground hover:text-primary transition-colors uppercase tracking-widest">
                        <div className="w-8 h-8 rounded-full border border-border flex items-center justify-center group-hover:border-primary/40 group-hover:bg-primary/5 transition-all">
