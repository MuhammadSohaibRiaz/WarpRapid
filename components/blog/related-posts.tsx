  ...
  return (
    <motion.section
      ...
      className={`${isDark ? "bg-gray-900/40" : "bg-white/40"
        } backdrop-blur-md rounded-lg p-6 shadow-lg border ${isDark ? "border-gray-700/50" : "border-gray-200/50"
        } theme-transition`}
    >
          ...
          {currentPosts.map((post, index) => (
            ...
            >
              <Link href={`/blog/${post.slug}`}>
                <div className={`rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 ${isDark ? "bg-gray-800/50" : "bg-white"
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="h-[3.5rem] mb-3">
                      <h4 className="text-lg font-bold theme-text theme-transition line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 leading-tight">
                        {post.title}
                      </h4>
                    </div>
                    ...
                    <div className="h-[4.5rem] mb-4">
                      <p className="text-sm theme-text opacity-70 theme-transition line-clamp-3 leading-relaxed">
                        {post.excerpt}
                      </p>
                    </div>

                    {/* Read More Link (Anchored to bottom) */}
